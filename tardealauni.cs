...
public class Program { static int ManejarLinea(string texto, int numeroSalto) { Console.WriteLine(texto);
...
static void Main()
{ string[] textos = new string[15]; int[] saltos = new int[15];
		...
		textos[14] = "Cruzas justo cuando pasa una moto. FINAL: NO LLEGASTE(Felicidades te atropellaron).";
		saltos[14] = 1;
